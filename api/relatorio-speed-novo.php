...
<body style="background-color:#f5f6fa;padding:0px;margin:0px;">
    ...
    <div class="container">
            ...
            <div class="flex-box">
                ...
                <div class="content-box">
                    <div class="content-box" style="margin:4%; ">
                        ...
                        <input type="number" id="speed" class="form-control" value="80" />
                    </div>
        ...
        <div class="content-box" style="margin:4%; ">
                ...
                <button type="button" id="botaokm" class="btn btn-outline-success" data-toggle="modal" data-target="#grafico"><i class="fa fa-chart-bar"></i> Gráfico </button>
            </div>
            <!-- <-- botao grafico -->
            <!-- <div class="content-box" style="margin:4%; ">
            </div> -->
...
<script>
    ...
    function gerarRelatorio() {
        ...
        $.ajax({
            url: 'https://itajobi.usinaitajobi.com.br/metronic/api/relatorio-speed-rel.php',
            type: 'POST',
            data: {
                v_login: login,
                v_veiculo: veiculo,
