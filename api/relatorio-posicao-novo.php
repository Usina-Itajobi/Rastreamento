...
<body style="background-color:#f5f6fa;padding:0px;margin:0px;">
    ...
    <div class="container">
        ...
        <div class="flex-box esconder">
            <p class="esconder">
                <center><strong style="color:#696;" class="esconder">Selecione um per&iacute;odo </strong></center>
            </p>
        </div>
        ...
        <div class="flex-box esconder">
            ...
            <input type="button" value="Gerar Relat&oacute;rio" class="content-box btn btn-success" onClick="gerarRelatorio();" />
        </div>
