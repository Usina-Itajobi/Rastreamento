...
<p>
        ...
        <script>
			...
			function relVelocidade(){
				...
				var login = $("#v_login").val();
				$.ajax({
					url: 'https://itajobi.usinaitajobi.com.br/metronic/api/relatorio-velocidade.php',
					type: 'POST',
					data: {			
						v_login: login
					},
			...
			function relPosicao(){
				...
				var login = $("#v_login").val();
				$.ajax({
					url: 'https://itajobi.usinaitajobi.com.br/metronic/api/relatorio-posicao.21072019.php',
					type: 'POST',
					data: {			
						v_login: login
					},
