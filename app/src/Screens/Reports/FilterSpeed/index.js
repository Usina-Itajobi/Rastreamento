...
const Reports = (props) => {
  ...
  const [speedMin, setSpeedMin] = useState('80');
  ...
  async function handleGenerateReport() {
    try {
      ...
      form.append('speed', speedMin ?? '0');

      const options = {
        method: 'POST',
        url: `https://itajobi.usinaitajobi.com.br/metronic/api/rel_speed.php`,
        headers: {
  ...
  return (
    <>
      <Header title="Relatório Velocidade" {...props} showBackButton />
      <ImageBackground
          ...
          <S.Container>
            <S.WrapperFilterDateHour>
              ...
              <S.WrapperFilterRow>
                ...
                <S.WrapperInputContent>
                  <S.ButtonChooseDateLabel>Velocidade Mínima</S.ButtonChooseDateLabel>

                  <S.WrapperInput>
                    <S.InputSpeedMin
                      keyboardType="numeric"
                      value={speedMin}
                      onChangeText={(text) => setSpeedMin(text.replace(/[^0-9]/g, ''))}
                      placeholder="Ex: 120"
              ...
              <>
                ...
                {reportData.length > 0 && (
                  <ScrollView horizontal>
                    <S.Table>
                      <S.TableHeader>
                        <S.TableCellHeader style={{ width: 70 }}>Placa</S.TableCellHeader>
                        <S.TableCellHeader style={{ width: 90 }}>Velocidade</S.TableCellHeader>
                        <S.TableCellHeader style={{ width: 100 }}>Data GPS</S.TableCellHeader>
                        <S.TableCellHeader style={{ width: 120 }}>Endereço</S.TableCellHeader>
                        <S.TableCellHeader style={{ width: 60 }}>Ligado</S.TableCellHeader>
                        <S.TableCellHeader style={{ width: 70 }}>KM</S.TableCellHeader>
                        <S.TableCellHeader style={{ width: 40 }}>Mapa</S.TableCellHeader>
                      </S.TableHeader>
                      ...
                      <FlatList
                        ...
                        renderItem={({ item }) => (
                          <S.TableRow>
                            <S.TableCell style={{ width: 70 }}>{item.placa}</S.TableCell>
                            <S.TableCell style={{ width: 90 }}>{item.speed} km/h</S.TableCell>
                            <S.TableCell style={{ width: 100 }}>{item.data}</S.TableCell>
                            <S.TableCell style={{ width: 120 }}>{item.endereco}</S.TableCell>
                            <S.TableCell style={{ width: 60 }}>{item.ligado ? 'Sim' : 'Não'}</S.TableCell>
                            <S.TableCell style={{ width: 70 }}>{item.km} km</S.TableCell>

                            <S.TableCell style={{ width: 40, alignItems: 'center' }}>
                              <S.MapButton onPress={() => openInMaps(item.lat, item.lng)}>
                                <MaterialIcons name="location-on" size={24} color="#004e70" />
                              </S.MapButton>
                            </S.TableCell>
                          </S.TableRow>
                        )}
